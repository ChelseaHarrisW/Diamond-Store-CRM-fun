...
#  Proposed data flow I have created using the DrawSQL platform :
...
3. When you are in the correct directory you should be free to Serve up the project on a new port (SERVE command), and paste the link to your browser. you should then see the image above
